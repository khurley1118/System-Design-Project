...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 23, 2018 at 02:43 AM
...
UPDATE course SET course.isActive = 0 where course.courseCode = courseCode$$
...
('2', 'Accounting', 1),
('3', 'Math', 1),
('4', 'Technical Writing', 1),
('5', 'Introduction to Programming', 1),
('6', 'Software Design', 1),
('7', 'Business Fundamentals', 1),
('8', 'Marketing', 1),
...
(16, '$2y$10$lKnUdS6HMPJ9VPBEOyw6Xu27rB99zbBXGanXj0O0HcWeR42CQEbz6', 2, 'Nick', 'Taggart', 'avatars/download (1).jpg'),
...
(1, '$2y$10$7K.KDNFwyJLQzdz.OfJ.juiaLCQTtufw5UaxzG/EX6mv482wZAV.e', 2, 'Mark', 'Patterson', 'avatars/images.jpg'),
...
(3, 'This is a default ticket', 'brad', 'butler', 12345, '2018-03-29', 'Resolved'),
(4, 'This is an inserted Test ticket', 'Bruce', 'Banner', 1234567, '2013-08-18', 'Resolved'),
(5, 'Additional Test ticket submitted by 123', 'MARK', 'patterson', 123, '2018-03-14', 'Resolved');
